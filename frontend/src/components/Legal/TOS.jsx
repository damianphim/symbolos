        ...
        <div className="legal-body">
          ...
          <section className="legal-section">
            ...
            <div className="legal-warning-box" style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
              ...
              <span><strong>Important:</strong> The AI advisor is for informational and planning purposes only. It is not a substitute for official McGill academic advising.</span>
            </div>
            <ul>
          ...
          <section className="legal-section">
            <h2>14. Contact</h2>
            <p>Questions about these Terms? Contact us at: <a href="mailto:symbolosadvsry@gmail.com">symbolosadvsry@gmail.com</a></p>
          </section>
        </div>
      </div>
    </div>
