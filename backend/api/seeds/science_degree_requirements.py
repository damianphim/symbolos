...

  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "24 credits from approved COMP/ECSE electives at 300+ level.",
        "sort_order": 2,
        "courses": [
          {"subject": "COMP", "catalog": "409", "title": "Concurrent Programming",              "credits": 3, "is_required": False},
          {"subject": "COMP", "catalog": "417", "title": "Introduction to Robotics and Intelligent Systems","credits": 3, "is_required": False},
...

  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "sort_order": 3,
        "courses": [
          {"subject": "COMP", "catalog": "462", "title": "Computational Genomics",              "credits": 3, "is_required": False},
          {"subject": "COMP", "catalog": "561", "title": "Genomics and Sequence Analysis",      "credits": 3, "is_required": False},
        ],
      },
      {
...

  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "sort_order": 5,
        "courses": [
          {"subject": "COMP", "catalog": "445", "title": "Natural Language Processing",        "credits": 3, "is_required": False},
          {"subject": "COMP", "catalog": "551", "title": "Applied Machine Learning",           "credits": 4, "is_required": False},
        ],
      },
      {
        ...
        "courses": [
          ...
          {"subject": "COMP", "catalog": "445", "title": "Natural Language Processing",        "credits": 3, "is_required": False},
          {"subject": "COMP", "catalog": "558", "title": "Computer Vision",                   "credits": 3, "is_required": False},
          {"subject": "COMP", "catalog": "579", "title": "Reinforcement Learning",             "credits": 3, "is_required": False},
        ],
      },
      {
...

  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "title": "Block 2 – Games Specialization (7+ credits)",
        "block_type": "choose_credits",
        "credits_needed": 7,
        "courses_needed": None,
    ...
    "blocks": [
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "MATH 222 is 0-3 credits (may be waived with credit).",
        "sort_order": 1,
        "courses": [
          {"subject": "MATH", "catalog": "222", "title": "Calculus 3",                         "credits": 3, "is_required": True},
      ...
      },
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "27 credits from MATH 400+.",
        "sort_order": 2,
        "courses": [
    ...
    "blocks": [
      {
        ...
        "courses": [
          ...
          {"subject": "PHYS", "catalog": "447", "title": "Majors Quantum Physics 2",                 "credits": 3, "is_required": True},
        ],
      },
      {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "courses": [
          ...
          {"subject": "PHYS", "catalog": "519", "title": "Advanced Biophysics",                   "credits": 3, "is_required": False},
          {"subject": "PHYS", "catalog": "521", "title": "Astrophysics",                          "credits": 3, "is_required": False},
          {"subject": "PHYS", "catalog": "534", "title": "Nanoscience",                           "credits": 3, "is_required": False},
