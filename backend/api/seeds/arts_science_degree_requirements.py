  ...
  # ══════════════════════════════════════════════════════════════════════
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "title": "Biophysical, Societal, Cultural, Institutional, and Ethical (15 credits – choose 5)",
        "block_type": "choose_credits",
        "credits_needed": 15,
        "courses_needed": 5,
        "group_name": None,
        "notes": "Choose 5 courses (15 credits) from this list. Verified from 2024-2025 eCalendar.",
        "sort_order": 2,
        "courses": [
          ...
          {"subject": "GEOG", "catalog": "203", "title": "Environmental Systems", "credits": 3, "is_required": False},
      ...
      },
      {
        ...
        "sort_order": 6,
        "courses": [
          {"subject": "AGRI", "catalog": "435",  "title": "Soil and Water Quality Management",           "credits": 3, "is_required": False},
          ...
          {"subject": "ENVR", "catalog": "544",  "title": "Environmental Measurement and Modelling",      "credits": 3, "is_required": False},
      ...
      },
      {
        ...
        "notes": "At least 3 credits from Area 2A. Verified from 2024-2025 eCalendar.",
        "sort_order": 7,
        "courses": [
          ...
          {"subject": "ENVR", "catalog": "519",  "title": "Global Environmental Politics",                "credits": 3, "is_required": False},
      ...
      },
      {
        ...
        "notes": (
          "At least 6 credits from Area 3. BIOL 540 and ENVR 540 cannot both be taken; "
          "BREE 217 and GEOG 322 cannot both be taken. Verified from 2024-2025 eCalendar."
        ),
        "sort_order": 9,
        "courses": [
          ...
          {"subject": "GEOG", "catalog": "350",  "title": "Physical Geography of the Tropics",       "credits": 3, "is_required": False},
  ...
  # ══════════════════════════════════════════════════════════════════════
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "notes": (
          "30 credits from at least THREE of the eight content areas; at least 6 credits at the "
          "400 level or higher. May take BIOL 308 or ENVB 305, not both. "
          "Verified from 2024-2025 eCalendar."
        ),
        "sort_order": 4,
        "courses": [
          ...
          {"subject": "BIOL", "catalog": "540",   "title": "Ecology of Species Invasions",         "credits": 3, "is_required": False},
          ...
          {"subject": "PLNT", "catalog": "460",   "title": "Plant Ecology",                        "credits": 3, "is_required": False},
        ],
      },
      {
        "block_key": "env_area2_biodiversity",
        "title": "Area 2 – Biodiversity and Conservation",
        "block_type": "group",
        "credits_needed": None,
        "courses_needed": None,
        "group_name": "Area 2 – Biodiversity and Conservation",
        "notes": "Verified from 2024-2025 eCalendar.",
        "sort_order": 5,
        "courses": [
          {"subject": "BIOL", "catalog": "305",   "title": "Animal Diversity",                     "credits": 3, "is_required": False},
          {"subject": "BIOL", "catalog": "310",   "title": "Biodiversity and Ecosystems",          "credits": 3, "is_required": False},
          {"subject": "BIOL", "catalog": "343",   "title": "Biodiversity in the Caribbean",        "credits": 3, "is_required": False},
          {"subject": "BIOL", "catalog": "427",   "title": "Herpetology",                          "credits": 3, "is_required": False},
          {"subject": "BIOL", "catalog": "465",   "title": "Conservation Biology",                 "credits": 3, "is_required": False},
          {"subject": "MICR", "catalog": "331",   "title": "Microbial Ecology",                    "credits": 3, "is_required": False},
          {"subject": "PLNT", "catalog": "358",   "title": "Flowering Plant Diversity",            "credits": 3, "is_required": False},
          {"subject": "WILD", "catalog": "307",   "title": "Natural History of Vertebrates",       "credits": 3, "is_required": False},
          {"subject": "WILD", "catalog": "350",   "title": "Mammalogy",                            "credits": 3, "is_required": False},
          {"subject": "WILD", "catalog": "420",   "title": "Ornithology",                          "credits": 3, "is_required": False},
        ],
      },
      {
        "block_key": "env_area3_field",
        "title": "Area 3 – Field Studies in Ecology and Conservation",
        "block_type": "group",
        "credits_needed": None,
        "courses_needed": None,
        "group_name": "Area 3 – Field Studies",
        "notes": "Verified from 2024-2025 eCalendar. BIOL 334D1/D2 must be taken as a pair (1.5 credits each).",
        "sort_order": 6,
        "courses": [
          {"subject": "BIOL", "catalog": "240",   "title": "Monteregian Flora",                    "credits": 3, "is_required": False},
          {"subject": "BIOL", "catalog": "331",   "title": "Ecology/Behaviour Field Course",       "credits": 3, "is_required": False},
          {"subject": "BIOL", "catalog": "334D1", "title": "Applied Tropical Ecology",             "credits": 1.5, "is_required": False},
          {"subject": "BIOL", "catalog": "334D2", "title": "Applied Tropical Ecology",             "credits": 1.5, "is_required": False, "notes": "Continuation of BIOL 334D1"},
          {"subject": "BIOL", "catalog": "335",   "title": "Marine Mammals",                       "credits": 3, "is_required": False},
          {"subject": "BIOL", "catalog": "553",   "title": "Neotropical Environments",             "credits": 3, "is_required": False},
          {"subject": "GEOG", "catalog": "495",   "title": "Field Studies – Physical Geography",   "credits": 3, "is_required": False},
          {"subject": "WILD", "catalog": "475",   "title": "Desert Ecology",                       "credits": 3, "is_required": False},
        ],
      },
      {
        "block_key": "env_area4_hydrology",
        "title": "Area 4 – Hydrology and Water Resources",
        "block_type": "group",
        "credits_needed": None,
        "courses_needed": None,
        "group_name": "Area 4 – Hydrology and Water Resources",
        "notes": "May take only one of GEOG 322, BREE 217, or CIVE 323. Verified from 2024-2025 eCalendar.",
        "sort_order": 7,
        "courses": [
      ...
      {
        "block_key": "env_area5_health",
        "title": "Area 5 – Human Health",
        "block_type": "group",
        "credits_needed": None,
        "courses_needed": None,
        "group_name": "Area 5 – Human Health",
        "notes": "Verified from 2024-2025 eCalendar.",
        "sort_order": 8,
        "courses": [
          {"subject": "NUTR", "catalog": "307",   "title": "Metabolism and Human Nutrition",       "credits": 3, "is_required": False},
          {"subject": "PARA", "catalog": "410",   "title": "Environment and Infection",            "credits": 3, "is_required": False},
          {"subject": "PATH", "catalog": "300",   "title": "Human Disease",                        "credits": 3, "is_required": False},
          {"subject": "PHAR", "catalog": "303",   "title": "Principles of Toxicology",             "credits": 3, "is_required": False},
        ],
      },
      {
        "block_key": "env_area6_earth",
        "title": "Area 6 – Earth and Soil Sciences",
        "block_type": "group",
        "credits_needed": None,
        "courses_needed": None,
        "group_name": "Area 6 – Earth and Soil Sciences",
        "notes": "Verified from 2024-2025 eCalendar.",
        "sort_order": 9,
        "courses": [
          {"subject": "ATOC", "catalog": "215",   "title": "Oceans, Weather and Climate",          "credits": 3, "is_required": False},
          {"subject": "ATOC", "catalog": "341",   "title": "Caribbean Climate and Weather",        "credits": 3, "is_required": False},
      ...
      {
        "block_key": "env_area7_economics",
        "title": "Area 7 – Economics",
        "block_type": "group",
        "credits_needed": None,
        "courses_needed": None,
        "group_name": "Area 7 – Economics",
        "notes": "May take AGEC 200 or ECON 208 (microeconomics), not both. Verified from 2024-2025 eCalendar.",
        "sort_order": 10,
        "courses": [
      ...
      },
      {
        ...
        "credits_needed": None,
        "courses_needed": None,
        "group_name": "Area 8 – Development and Underdevelopment",
        "notes": "Verified from 2024-2025 eCalendar.",
        "sort_order": 11,
        "courses": [
