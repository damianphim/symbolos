  ...
  # ────────────────────────────────────────────────────────────
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "group_name": None,
        "notes": (
          "Required methods: EDEE 223, 230, 253, 260, 270, 273, 280, 283, 332, 353, 355; "
          "EDER 360; EDPE 300; EDPI 309, 341 (some in professional core). "
        ...
        "courses": [
          ...
          {"subject": "EDEE", "catalog": "230", "title": "Elementary School Mathematics 1",                "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Mathematics curriculum and pedagogy for elementary school; required."},
          {"subject": "EDEE", "catalog": "253", "title": "Kindergarten Classroom Pedagogy",                "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Kindergarten-specific pedagogy and developmental approaches; required."},
          {"subject": "EDEE", "catalog": "260", "title": "Reading Methods – Kindergarten/Elementary",      "credits": 3, "is_required": True},
          {"subject": "EDEE", "catalog": "270", "title": "Elementary School Science",                      "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Science methods for elementary school; required."},
          {"subject": "EDEE", "catalog": "273", "title": "Elementary School Science 2",                    "credits": 3, "is_required": True},
          {"subject": "EDEE", "catalog": "280", "title": "Geography, History and Citizenship Education",   "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Social studies foundation course for elementary teachers; required."},
          {"subject": "EDEE", "catalog": "283", "title": "Social Studies Pedagogy",                        "credits": 3, "is_required": True},
          {"subject": "EDEE", "catalog": "332", "title": "Teaching Elementary Mathematics 2",              "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Continuation of elementary mathematics pedagogy; required."},
          {"subject": "EDEE", "catalog": "353", "title": "Third Year Professional Seminar",                "credits": 3, "is_required": True},
          {"subject": "EDEE", "catalog": "355", "title": "Classroom-based Evaluation",                    "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Assessment and evaluation methods for K-6 classrooms; required."},
          {"subject": "EDER", "catalog": "360", "title": "Culture and Citizenship in Quebec Context",      "credits": 2, "is_required": True,  "recommended": True,  "recommendation_reason": "Required for Quebec teacher certification; addresses Culture & Citizenship curriculum strand."},
          {"subject": "EDPI", "catalog": "309", "title": "Diverse Learners",                               "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Required; understanding diverse learning needs in inclusive K-6 classrooms."},
    ...
    "blocks": [
      {
        ...
        "courses": [
          ...
          {"subject": "EDES", "catalog": "350", "title": "Classroom Practices",                            "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Required classroom management and instructional strategies course for all Secondary programs."},
    ...
    "blocks": [
      {
        ...
        "courses": [
          ...
          {"subject": "EDPE", "catalog": "300", "title": "Psychological Foundations of Education",         "credits": 3, "is_required": True},
          {"subject": "EDPE", "catalog": "304", "title": "Measurement and Evaluation",                     "credits": 3, "is_required": True},
          {"subject": "EDPI", "catalog": "309", "title": "Diverse Learners",                               "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Required; understanding diverse learning needs in secondary classrooms."},
          {"subject": "EDPI", "catalog": "341", "title": "Instruction in Inclusive Schools",               "credits": 3, "is_required": True},
          {"subject": "EDES", "catalog": "350", "title": "Classroom Practices",                            "credits": 3, "is_required": True,  "recommended": True,  "recommendation_reason": "Required classroom management and instructional strategies course for all Secondary programs."},
          {"subject": "EDEC", "catalog": "404", "title": "Fourth Year Professional Seminar (Secondary)", "credits": 3, "is_required": True},
        ],
    ...
    "blocks": [
      ...
      },
      {
        ...
        "courses": [
          ...
          {"subject": "EDES", "catalog": "434", "title": "Teaching Secondary Social Sciences 2",           "credits": 3, "is_required": True},
    ...
    "blocks": [
      ...
      },
      {
        ...
        "courses": [
          ...
          {"subject": "EDKP", "catalog": "213", "title": "Aquatics",                                       "credits": 1, "is_required": True},
    ...
    "blocks": [
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "Same required courses as the regular B.Sc.(Kinesiology) program plus EDKP 215 (First Aid/CPR, 0 cr graduation requirement).",
        "sort_order": 1,
        "courses": [
          ...
          {"subject": "EDKP", "catalog": "261", "title": "Motor Development",                              "credits": 3, "is_required": True},
          {"subject": "EDKP", "catalog": "292", "title": "Nutrition and Wellness",                         "credits": 3, "is_required": True},
          {"subject": "EDKP", "catalog": "330", "title": "Physical Activity and Public Health",            "credits": 3, "is_required": True},
          ...
          {"subject": "EDKP", "catalog": "396", "title": "Adapted Physical Activity",                      "credits": 3, "is_required": True},
          {"subject": "EDKP", "catalog": "443", "title": "Research Methods",                               "credits": 3, "is_required": True},
          {"subject": "EDKP", "catalog": "447", "title": "Motor Control",                                  "credits": 3, "is_required": True},
          {"subject": "EDKP", "catalog": "448", "title": "Exercise and Health Psychology",                 "credits": 3, "is_required": True},
          {"subject": "EDKP", "catalog": "450", "title": "Advanced Principles in Applied Kinesiology",    "credits": 3, "is_required": True},
          {"subject": "EDKP", "catalog": "498", "title": "Sport Psychology",                               "credits": 3, "is_required": True},
